...
- [x] **T201** Registrar a decisão de stack local e seus limites em ADR.
- [x] **T202** Inicializar Git local, ignorar artefatos e configurar hooks versionados.
- [x] **T203** Criar scripts de format, lint, typecheck, testes, cobertura e validação de specs.
- [x] **T204** Implementar primitiva mínima de escopo de condomínio com testes.
