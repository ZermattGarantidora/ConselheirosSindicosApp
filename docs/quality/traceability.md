...
| RQ-005 Resposta fundamentada             | AC-010, AC-011 | EVAL-001–EVAL-005, EVAL-015 | `apps/api/answers/answer-gateway.ts`; `apps/api/answers/answer-use-case.ts`; `tests/unit/answer-gateway.test.ts`; `tests/unit/answer-use-case.test.ts` |
| RQ-006 Citações verificáveis             | AC-012, AC-013 | EVAL-001–EVAL-005, EVAL-015 | `apps/api/answers/citation-validator.ts`; `apps/web/App.tsx`; `tests/unit/citation-validator.test.ts`; `tests/unit/api-answers.test.ts` |
...
| RQ-012 Auditoria e custo                 | AC-020 | EVAL-020 | `apps/api/answers/answer-persistence.ts`; `apps/api/answers/postgres-answer-persistence.ts`; `infrastructure/database/009_answers_feedback_audit.sql`; `tests/unit/postgres-answer-persistence.test.ts` |
